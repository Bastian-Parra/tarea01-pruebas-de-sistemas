...
class TestDistanceService(unittest.TestCase):
    ...
    # probar con la latitud en el valor de frontera inferior y superior.
    ...
    def test_latitude_out_of_range(self):
        ...
        # Test con latitud fuera del rango permitido (-91)
        ...
        #se espera que falle porque la latitud está fuera del rango permitido
        self.assertIsNotNone(res)

        #El valor esperado debe indicar un error, como res.distance = -1

        self.assertNotEqual(res.distance, -1)  #forzamos fallo si devuelve -1
        self.assertNotEqual(res.unit, "invalid")  #forzamos fallo si la unidad es inválida
        ...
        # Nuevamente, esperar que falle si devuelve valores incorrectos
        self.assertIsNotNone(res2)
        self.assertNotEqual(res2.distance, -1)  # Fallo si devuelve -1
        self.assertNotEqual(res2.unit, "invalid")  # Fallo si devuelve unidad inválida
    ...
    def test_invalid_unit(self):
        ...
        if res.unit != "km" and res.unit != "nm":
            ...
            self.assertEqual(res.unit, "unidad_invalida")  # Cambiar para que falle intencionalmente
            print_result(res, id)

    # 8. Probar cuando los puntos de origen y destino son los mismos
    ...
    # 9. Probar con latitud y longitud válidas pero con unidad de medida en "nm"
    ...
    # 10. Probar el cálculo de distancia con latitud cercana a los límites
